...
//1
                        ...
                        try
                        {
                         ...
                         if(!session.getAttribute("userFunction").equals("Farmer"))
                         {
                             ...
                             {
                               rrs=rst.executeQuery("select * from farmerstb order by name,surname  asc");  
                             }
                             else{
                                 
                          rrs=rst.executeQuery("select * from farmerstb,landstb where farmerstb.farmerid=landstb.farmerid and landstb.location='"+session.getAttribute("userLocation")+"'");
                             }
                          if(rrs.first())
                          {
                              rrs.beforeFirst();
...
document.add(new Paragraph("List of farmers",subfont));
