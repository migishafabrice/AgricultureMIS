...
//1
                        ...
                        try
                        {
                            ResultSet rrs=null;
                             ...
                             {
                               rrs=rst.executeQuery("select * from applicantstb,landstb where decision='Rejected' and applicantstb.landid=landstb.landid "
                          ...
                          rrs=rst.executeQuery("select * from applicantstb,landstb where decision='Rejected' and applicantstb.landid=landstb.landid and "
                             ...
                             {
                               rrs=rst.executeQuery("select * from applicantstb,landstb where decision='Rejected' and applicantstb.farmerid='"+session.getAttribute("userCode").toString()+"' and applicantstb.landid=landstb.landid "
                                  + "order by season asc, year desc");  
                             }
                          if(rrs.first())
                          {
...
document.add(new Paragraph("Satus:Rejected",new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
