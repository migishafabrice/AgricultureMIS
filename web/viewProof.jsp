...
//1
                        ...
                        try
                        {
                            ResultSet rrs=null;
                               ...
                               rrs=rst.executeQuery("select * from applicantstb,landstb where applicantstb.applicationid='"+request.getParameter("viewapp")+"' and applicantstb.landid=landstb.landid "
...
document.addTitle("Application document");
document.add(new Paragraph("E-AGRICULTURE SYSTEM",new Font(Font.TIMES_ROMAN,12,Font.BOLD)));
document.add(new Paragraph("Status:"+rrs.getString("decision"),new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
...
document.add(new Paragraph("Application details",subfont));
...
table.addCell(getNormalCell(rrs.getString("comment"),"greek",10));
                          ...
                          ResultSet rscheck=stcheck.executeQuery("select * from stafftb where staffid='"+rrs.getString("decidedby")+"'");
                          if(rscheck.first())
                          {
   document.add(new Paragraph("\n",new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
document.add(new Paragraph("CHECKED BY:",new Font(Font.TIMES_ROMAN,11,Font.BOLD | Font.UNDERLINE)));
document.add(new Paragraph("Position:"+rscheck.getString("position"),new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
document.add(new Paragraph("Names:"+rscheck.getString("name")+" "+rscheck.getString("surname"),new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
document.add(new Paragraph("Telephone:"+rscheck.getString("telephone"),new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
document.add(new Paragraph("Email:"+rscheck.getString("email"),new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
document.add(new Paragraph("Date:"+rrs.getString("decisiondate"),new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
                          }
                          else
                          {
                           document.add(new Paragraph("\n",new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
document.add(new Paragraph("CHECKED BY:",new Font(Font.TIMES_ROMAN,11,Font.BOLD | Font.UNDERLINE)));
document.add(new Paragraph("Position:xxxxxxxxxxxxxxxxxxxxxx",new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
document.add(new Paragraph("Names:xxxxxxxxxxxxxxxxxxxxxxx",new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
document.add(new Paragraph("Telephone:xxxxxxxxxxxxxxxxxxxx",new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
document.add(new Paragraph("Email:xxxxxxxxxxxxxxxxxxxxxxxx",new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
document.add(new Paragraph("Date:xxxxxxxxxxxxxxxxxxxxxxxxx",new Font(Font.TIMES_ROMAN,11,Font.BOLD)));   
                          }
document.close(); 
