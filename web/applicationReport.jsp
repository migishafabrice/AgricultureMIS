...
//1
                        ...
                        try
                        {
                            ResultSet rrs=null;
                             ...
                             {
                               rrs=rst.executeQuery("select * from applicantstb,landstb where applicantstb.landid=landstb.landid "
                          ...
                          rrs=rst.executeQuery("select * from applicantstb,landstb where applicantstb.landid=landstb.landid and "
                             ...
                             {
                               rrs=rst.executeQuery("select * from applicantstb,landstb where applicantstb.farmerid='"+session.getAttribute("userCode").toString()+"' and applicantstb.landid=landstb.landid "
                                  + "order by season asc, year desc");  
                             }
                          if(rrs.first())
                          {
...
document.add(new Paragraph("Satus:ALL",new Font(Font.TIMES_ROMAN,11,Font.BOLD)));
